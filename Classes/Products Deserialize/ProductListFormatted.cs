...
// Type: Relatorio_Produtos_VHSYS.Classes.Products_Deserialize.ProductListFormatted
...
{
  internal class ProductListFormatted
  {
    public string nome { get; set; }

    public int qtd_vendido { get; set; }

    public string valor_vendido { get; set; }
  }
}
